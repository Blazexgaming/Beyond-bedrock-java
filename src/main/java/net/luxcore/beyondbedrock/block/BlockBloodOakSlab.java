...
public class BlockBloodOakSlab extends ElementsBeyondbedrockMod.ModElement {
	@GameRegistry.ObjectHolder("beyondbedrock:blood_oak_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("beyondbedrock:blood_oak_slab_double")
	public static final Block block_slab_double = null;
	public BlockBloodOakSlab(ElementsBeyondbedrockMod instance) {
		super(instance, 45);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("blood_oak_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("blood_oak_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("beyondbedrock:blood_oak_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("blood_oak_slab");
